...
while true; do
         ...
         #Ens160
         in_ens=$(snmpget -Oqv -v2c -c HELMpAllUser9465CmA 192.168.128.24 1.3.6.1.2.1.31.1.1.1.2.2 )
         out_ens=$(snmpget -Oqv -v2c -c HELMpAllUser9465CmA 192.168.128.24 1.3.6.1.2.1.31.1.1.1.4.2)
         echo "$(date +"%Y-%m-%d %H:%M:%S");ens160;0:50:56:8b:4f:66;${in_ens};${out_ens}" >> "ens160.csv"

         #Disk Root
         stockage_r=$(snmpwalk -Oqv -v2c -c HELMpAllUser9465CmA 192.168.128.24 1.3.6.1.2.1.25.2.3.1.6.31)
         ...
         #Disk All
         for i in $(snmpwalk -Oqv -v2c -c HELMpAllUser9465CmA 192.168.128.24 1.3.6.1.2.1.25.2.3.1.1)
                do
                        nom=$(snmpwalk -Oqv -v2c -c HELMpAllUser9465CmA 192.168.128.24 1.3.6.1.2.1.25.2.3.1.3.$i)
                        stockage=$(snmpwalk -Oqv -v2c -c HELMpAllUser9465CmA 192.168.128.24 1.3.6.1.2.1.25.2.3.1.6.$i)
                        echo "Disk Usage : $(date +"%Y-%m-%d %H:%M:%S");${nom};${stockage}"
                        echo "$(date +"%Y-%m-%d %H:%M:%S");${nom};${stockage}" >> "disk.csv"
                done
         #Net interface All
         for i in $(snmpwalk -Oqv -v2c -c HELMpAllUser9465CmA 192.168.128.24 1.3.6.1.2.1.2.2.1.1)
                do
                        name=$(snmpget -Oqv -v2c -c HELMpAllUser9465CmA 192.168.128.24 1.3.6.1.2.1.31.1.1.1.1.$i)

                        in=$(snmpget -Oqv -v2c -c HELMpAllUser9465CmA 192.168.128.24 1.3.6.1.2.1.31.1.1.1.2.$i )
                        out=$(snmpget -Oqv -v2c -c HELMpAllUser9465CmA 192.168.128.24 1.3.6.1.2.1.31.1.1.1.4.$i)
